...
跑物理通用检查（能量守恒、瑞利极限、大尺寸极限等）+ PyMieScatt 第三方交叉验证。这是"AI 没法糊弄"的硬约束层。
...
- 4 层检验顺序：物理硬约束→极限退化→PyMieScatt 交叉→论文图量化
- 任何一层 fail 立即停，不继续
...
1. 4 层检验都过了吗？哪层 fail？
2. PyMieScatt 和我们实现差多少？在容差内吗？
3. 三方（我们/PyMieScatt/论文图）一致吗？
4. 可以进结果分析了吗，还是要回 step 04 修代码？
